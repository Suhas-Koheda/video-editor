...
# Worker for initial processing (Speech to Text + Entity Extraction)
class AnalysisWorker(QThread):
    finished = Signal(list) # List of segments with entities
    error = Signal(str)
    status = Signal(str)
...
# Worker for rendering the final video
